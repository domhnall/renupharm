...
describe Marketplace::Account do
  ...
  before :all do
    ...
    @payout_1 = create_seller_payout(pharmacy: @seller, total_cents: 32000, currency_code: "EUR")
    @payout_2 = create_seller_payout(pharmacy: @seller, total_cents: 21000, currency_code: "EUR")
  end
  ...
  describe "instance method" do
    ...
    describe "#total_payouts_to_date" do
      ...
      it "should represent the combined value of all payouts already processed" do
        expect(Marketplace::Account.new(pharmacy: @seller).total_payouts_to_date.price_cents).to eq 53_000
