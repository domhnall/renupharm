...
ActiveRecord::Schema.define(version: 2019_05_12_200915) do
  ...
  create_table "marketplace_order_feedbacks", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    t.bigint "marketplace_order_id"
    t.bigint "user_id"
    t.integer "rating"
    t.text "message"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["marketplace_order_id"], name: "index_marketplace_order_feedbacks_on_marketplace_order_id"
    t.index ["user_id"], name: "index_marketplace_order_feedbacks_on_user_id"
  end
  ...
  add_foreign_key "marketplace_order_feedbacks", "marketplace_orders"
  add_foreign_key "marketplace_order_feedbacks", "users"
